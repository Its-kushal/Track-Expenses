...
export default function Navbar({ onAddClick }: NavbarProps) {
    ...
    return (
        <>
            ...
            {/* MOBILE NAVBAR */}
            <div className="md:hidden fixed bottom-0 left-0 right-0 bg-[var(--color-surface)] border-t border-[var(--color-border)] pb-safe z-50 px-2 shadow-2xl">
                <div className="flex justify-between items-center h-16 relative w-full">
                    {/* LEFT SIDE: Home & Groups */}
                    ...
                    <div className="flex w-2/5 justify-evenly">
                        ...
                        {/* CHANGED FROM PROFILE TO ACTIVITY */}
                        <Link
                            href="/activity"
                            className="flex flex-col items-center justify-center w-12 text-[var(--color-muted)] hover:text-white transition-colors"
                        >
